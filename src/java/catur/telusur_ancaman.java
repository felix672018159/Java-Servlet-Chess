...
public class telusur_ancaman {
    ...
    public Boolean cek_aman = true;
    public Boolean bukan_karena_raja = false;
    public String teks = "";
    
    public telusur_ancaman(String[][][] posisi, int[] posisiakhir,String warna){
                ...
                if(!this.semuaposisi[posy][posx][0].equals(warna)){
                    if(this.semuaposisi[posy][posx][1].equals("banteng")||
                       this.semuaposisi[posy][posx][1].equals("ster")){
                           this.cek_aman = false;
                           this.bukan_karena_raja = true;
                    }
                    break;
                }
                
               if(this.semuaposisi[posy][posx][1].equals("raja")&&this.semuaposisi[posy][posx][0].equals(warna)){}else{
                   break;
               }
            }else{
            }
        ...
        if(y<0||y>7||x<0||x>7){
            ...
            if(!this.semuaposisi[y][x][0].equals("")){
                if(!this.semuaposisi[y][x][0].equals(warna)&&this.semuaposisi[y][x][0].equals("p")){
                    //jika warna posisi tidak sama dengan warnya yang melangkah dan warna posisi adalah putih
        ...
        if(y<0||y>7||x<0||x>7){
            ...
            if(!this.semuaposisi[y][x][0].equals("")){
                if(!this.semuaposisi[y][x][0].equals(warna)){
                    //jika warna posisi tidak sama dengan warnya yang melangkah dan warna posisi adalah putih
                    if(this.semuaposisi[y][x][1].equals("raja")){
                           this.cek_aman = false;
                    }
                }
            }else{}
